...
const program = new Command()
  .name('fags')
  .description('FreeChipStore CLI — scaffold, check, and publish browser AI agents.')
  .version('0.2.0');
...
program
  .command('publish')
  .description('Publish agent to FreeChipStore (creates repo, pushes code, registers route)')
