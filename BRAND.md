# FreeChipStore Brand Guidelines

## Mission

FreeChipStore is an open platform for browser-based AI tools — libraries, models, and agents that run on the user's hardware. Free forever, fully private, open source. No cloud inference cost, no subscription, no tracking.
...
- **FreeChipStore** — written as one word with "Agent" highlighted in accent purple
...
### Footer (all pages)
```
FreeChipStore · Docs · GitHub · Pro
FreeStore Family: FreeAppStore | FreeGameStore | FreeWebStore | FreeChipStore
```
...
| **FreeChipStore** | **Purple `#7c3aed`** | **A** | **freechipstore.online** |
