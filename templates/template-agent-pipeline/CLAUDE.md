...
A **pipeline** heuristic agent on [FreeChipStore](https://freechipstore.online).
...
[Trainer](https://freechipstore.online/a/trainer/). Train the classifier
...
Push to main = auto-deploy to https://freechipstore.online/a/AGENTNAME/
